...
const sharedConfig = {
  ...
  policies: [aws.iam.AWSLambdaVPCAccessExecutionRole, aws.iam.AWSLambdaExecute]
};

export const createCallbackLambda = (
  lambdaName: string,
  handler: aws.lambda.CallbackFactory<any, any>,
  params?: Partial<aws.lambda.CallbackFunctionArgs<any, any>>
) => {
